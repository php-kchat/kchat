...
@section('title', __("lang.notification"))
...
<div class="col-md-10 pt-3">
            <div class="card shadow-sm rounded bg-white mb-3">
                <div class="card-header border-bottom p-3">
                    <h6 class="m-0 float-left">{{ __("lang.notifications") }}</h6>
					<div class="btn-group float-right">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<button class="dropdown-item" type="button" onclick="delete_notificatios()"></i> {{ __("lang.delete") }}</button>
                        ...
                        <span class="ml-auto mb-auto">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <button class="dropdown-item" type="button" ajax_post data-msg="Are you sure you want to delete notifications?" action="/notification/delete" form="not{{ $info->id }}"><i class="mdi mdi-delete"></i> {{ __("lang.delete") }}</button>
                                </div>
                            </div>
                            <br />
