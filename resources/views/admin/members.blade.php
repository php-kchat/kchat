         ...
         <div class="card-actions float-right">
            <div class="dropdown show">
               ...
               <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" onclick="delete_users()" ><i class="fa fa-trash mr-2"></i>{{ __("lang.delete") }}</a>
                  <a class="dropdown-item" onclick="set_inactive_users()" ><i class="fa fa-pause-circle mr-2"></i>{{ __("lang.set-inactive") }}</a>
                  <a class="dropdown-item" onclick="set_active_users()" ><i class="fa fa-play-circle mr-2"></i>{{ __("lang.set-active") }}</a>
                  ...
                  <a class="dropdown-item" onclick="make_admins()" ><i class="fa fa-shield mr-2"></i>{{ __("lang.make-admin") }}</a>
                  <a class="dropdown-item" onclick="revoke_admins()" ><i class="fa fa-user mr-2"></i>{{ __("lang.revoke-admin-power") }}</a>
         ...
         <div class="card-actions float-right">
            <div class="dropdown show">
               ...
               <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" onclick="delete_user()" ><i class="fa fa-trash mr-2"></i>{{ __("lang.delete") }}</a>
                  <a class="dropdown-item" onclick="set_inactive_user()" ><i class="fa fa-pause-circle mr-2"></i>{{ __("lang.set-inactive") }}</a>
                  <a class="dropdown-item" onclick="set_active_user()" ><i class="fa fa-play-circle mr-2"></i>{{ __("lang.set-active") }}</a>
                  ...
                  <a class="dropdown-item" onclick="make_admin()" ><i class="fa fa-shield mr-2"></i>{{ __("lang.make-admin") }}</a>
                  <a class="dropdown-item" onclick="revoke_admin()" ><i class="fa fa-user mr-2"></i>{{ __("lang.revoke-admin-power") }}</a>
               </div>
            </div>
         </div>
